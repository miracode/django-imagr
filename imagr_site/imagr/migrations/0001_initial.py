    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('following', models.ManyToManyField(related_name='followers', null=True, verbose_name=b'People I follow', to=settings.AUTH_USER_MODEL, blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_modified', models.DateTimeField(null=True, verbose_name=b'date modified', blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_published', models.DateTimeField(null=True, verbose_name=b'date published', blank=True)),
                ('published', models.CharField(max_length=8, choices=[(b'private', b'This is private'), (b'shared', b'This is shared'), (b'public', b'This is public')])),
                ('owner', models.ForeignKey(related_name='photos', verbose_name=b'Owner of photo', to=settings.AUTH_USER_MODEL)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.AddField(
            model_name='album',
            name='owner',
            field=models.ForeignKey(verbose_name=b'Owner of album', to=settings.AUTH_USER_MODEL),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='album',
